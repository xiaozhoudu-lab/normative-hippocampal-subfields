...
clinical_datapath='E:/Lifespan_freesurfer_results/Github/Datasets/Dataset-diseases/Clinical_vars.csv'  # Change the directory where you save the clinical variables  
MR_datapath='E:/Lifespan_freesurfer_results/Github/Datasets/Dataset-diseases/MR_measures.xlsx'  # Change the directory where you save the MR measures  
...
savepath='E:/Lifespan_freesurfer_results/Github/Test_results/Diseases';# Create and determine the directory where you would save the results  
